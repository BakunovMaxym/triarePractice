...
export class RemakeUserMakeSetingsAndColections1747210582440 implements MigrationInterface {
    name = 'RemakeUserMakeSetingsAndColections1747210582440'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "folders" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "name" text NOT NULL, "course_ids" uuid array, "parent_folder_id" uuid, "owner_id" uuid, CONSTRAINT "PK_8578bd31b0e7f6d6c2480dbbca8" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "courses" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "name" character varying(255) NOT NULL, "students_count" integer NOT NULL DEFAULT '0', "teachers_count" integer NOT NULL DEFAULT '0', "owner_id" uuid, "category_id" uuid, "sub_category_id" uuid, "folder_id" uuid, CONSTRAINT "PK_3f70a487cc718ad8eda4e6d58c9" PRIMARY KEY ("id"))`);
